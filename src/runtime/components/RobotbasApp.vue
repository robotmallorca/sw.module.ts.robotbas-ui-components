...
import type { ToasterProps } from './RobotbasToaster.vue'
...
<template>
  <ConfigProvider :use-id="() => (useId() as string)" :dir="props.dir || locale?.dir" :locale="locale?.code"
    v-bind="configProviderProps">
    <TooltipProvider v-bind="tooltipProps">
      <RobotbasToaster v-if="toaster !== null" v-bind="toasterProps">
        <slot />
      </RobotbasToaster>
      <slot v-else />
