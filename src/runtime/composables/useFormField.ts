...
import type { RobotbasFormFieldProps } from '../types'
...
export const formFieldInjectionKey: InjectionKey<ComputedRef<FormFieldInjectedOptions<RobotbasFormFieldProps>> | undefined> = Symbol('nuxt-ui.form-field')
