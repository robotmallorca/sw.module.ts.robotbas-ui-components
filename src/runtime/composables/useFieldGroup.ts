...
import type { RobotbasFieldGroupProps } from '../components/RobotbasFieldGroup.vue'
import type { GetObjectField } from '../types/utils'

export const fieldGroupInjectionKey: InjectionKey<ComputedRef<{
  size: RobotbasFieldGroupProps['size']
  orientation: RobotbasFieldGroupProps['orientation']
