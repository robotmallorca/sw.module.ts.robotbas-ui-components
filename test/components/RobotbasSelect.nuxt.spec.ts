...
import RobotbasSelect, { type RobotbasSelectItem, type RobotbasSelectProps, type RobotbasSelectSlots } from '../../src/runtime/components/RobotbasSelect.vue'
...
describe('Select', () => {
  ...
  it.each([
    ...
    ['with valueKey', { props: { ...props, valueKey: 'label' as keyof RobotbasSelectItem, defaultValue: 'Backlog' } }],
  ...
  ])('renders %s correctly', async (nameOrHtml: string, options: { props?: RobotbasSelectProps<any, any, boolean>, slots?: Partial<RobotbasSelectSlots> }) => {
    const html = await ComponentRender(nameOrHtml, options, RobotbasSelect)
  ...
  it.each([
    ...
    const wrapper = mount(RobotbasSelect, {
      ...options
    })
  ...
  it('passes accessibility tests', async () => {
    const wrapper = await mountSuspended(RobotbasSelect, {
      props: {
        ...props,
  ...
  describe('emits', () => {
    test('update:modelValue event', async () => {
      const wrapper = mount(RobotbasSelect, { props: { items: ['Option 1', 'Option 2'] } })
