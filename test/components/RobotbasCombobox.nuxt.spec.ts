...
import RobotbasCombobox, { type RobotbasComboboxItem, type RobotbasComboboxProps, type RobotbasComboboxSlots } from '../../src/runtime/components/RobotbasCombobox.vue'


describe('RobotbasCombobox', () => {
  ...
  const props = { open: true, portal: false, items } as RobotbasComboboxProps
  ...
  it.each([
    ...
    ['with valueKey', { props: { ...props, valueKey: 'label' as keyof RobotbasComboboxItem, defaultValue: 'Backlog' } }],
  ...
  ])('renders %s correctly', async (nameOrHtml: string, options: { props?: RobotbasComboboxProps<any, any, boolean>, slots?: Partial<RobotbasComboboxSlots> }) => {
    const html = await ComponentRender(nameOrHtml, options, RobotbasCombobox)
  ...
  it.each([
    ...
    const wrapper = mount(RobotbasCombobox, {
      ...options
    })
  ...
  it('passes accessibility tests', async () => {
    const wrapper = await mountSuspended(RobotbasCombobox, {
      props: {
        ...props,
        modelValue: items[0]
  ...
  describe('emits', () => {
    test('update:modelValue event', async () => {
      const wrapper = mount(RobotbasCombobox, { props: { items: ['Option 1', 'Option 2'] } })
