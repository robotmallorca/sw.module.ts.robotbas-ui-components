...
import type { RobotbasFormFieldProps, RobotbasFormFieldSlots } from '../../src/runtime/types'

const inputComponents = [RobotbasInput, RobotbasSelect, RobotbasCombobox]

async function renderFormField(options: {
  props: Partial<RobotbasFormFieldProps>
  inputComponent: typeof inputComponents[number]
}) {
  return await mountSuspended(RobotbasFormField, {
    props: options.props,
    slots: {
      default: {
...
describe('RobotbasFormField', () => {
  ...
  ])('renders %s correctly', async (nameOrHtml: string, options: { props?: RobotbasFormFieldProps, slots?: Partial<RobotbasFormFieldSlots> }) => {
