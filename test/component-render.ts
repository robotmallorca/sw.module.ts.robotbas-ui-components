...
/**
 * Azúcar tipado sobre `it.each` para tests de render por snapshot. Si no se pasa
 * callback, monta el componente con cada caso y hace `toMatchSnapshot()` automáticamente.
 */
