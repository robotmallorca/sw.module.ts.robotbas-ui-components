...
export const sections: ShowcaseSection[] = [
  ...
  { id: 'icons', label: 'Iconos', title: 'RobotbasIcon', icon: 'bi bi-emoji-smile', description: 'Renderiza cualquier fuente de iconos por clase. Aquí, Bootstrap Icons.', component: IconsDemo },
  { id: 'buttons', label: 'Botones', title: 'Button', icon: 'bi bi-hand-index-thumb', description: 'Estilo por defecto y variantes vía la prop ui.', component: ButtonsDemo },
  ...
  { id: 'avatars', label: 'Avatares', title: 'Avatar · AvatarGroup · Chip', icon: 'bi bi-people', component: AvatarsDemo },
  ...
  { id: 'forms', label: 'Formularios', title: 'Input · FormField · InputIterator · FieldGroup', icon: 'bi bi-input-cursor-text', component: FormsDemo },
  { id: 'select', label: 'Select', title: 'Select · Combobox · SelectTree', icon: 'bi bi-menu-button-wide', description: 'Desplegables accesibles con menú en portal (estilados con Bootstrap).', component: SelectsDemo },
  { id: 'toggle', label: 'Toggle', title: 'ToggleGroup', icon: 'bi bi-toggles', description: 'Selección exclusiva de una opción.', component: ToggleDemo },
  { id: 'tabs', label: 'Tabs', title: 'Tabs', icon: 'bi bi-segmented-nav', component: TabsDemo },
  { id: 'disclosure', label: 'Acordeón', title: 'Accordion · Collapsible', icon: 'bi bi-list-nested', component: DisclosureDemo },
  { id: 'progress', label: 'Progreso', title: 'Progress', icon: 'bi bi-bar-chart-steps', component: ProgressDemo },
  { id: 'tree', label: 'Árbol', title: 'Tree', icon: 'bi bi-diagram-2', description: 'Árbol jerárquico navegable por teclado.', component: TreeDemo },
  { id: 'overlays', label: 'Overlays', title: 'Modal · Popover', icon: 'bi bi-window-stack', component: OverlaysDemo },
  ...
  { id: 'navigation', label: 'Navegación', title: 'SideBarLink · SideBarCheckbox', icon: 'bi bi-signpost-split', description: 'Elementos de menú lateral: enlaces con badge y checkboxes con submenús.', component: NavigationDemo },
